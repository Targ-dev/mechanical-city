      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white/95 backdrop-blur-xl px-4 text-[11px] font-medium text-gray-500 uppercase tracking-widest">Already have an account?</span>
          </div>
        </div>

        <div className="mt-5">
          <Link href="/login" className="flex w-full items-center justify-center rounded-2xl bg-white px-3 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-100 hover:bg-gray-50 transition-colors">
            Sign in
          </Link>
        </div>
      </div>
...
export default function RegisterPage() {
  return (
    <div className="relative min-h-[calc(100vh-100px)] flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden z-0 w-full">
        ...
        <div className="bg-white/95 backdrop-blur-3xl pt-8 pb-8 px-6 sm:px-8 shadow-2xl ring-1 ring-gray-900/5 sm:rounded-[2rem] rounded-[1.5rem] relative overflow-hidden border border-white/60">
          ...
          <div className="relative">
            ...
            <p className="text-center text-[13px] leading-relaxed text-gray-500 mb-6 max-w-[280px] mx-auto">
              Join Mechanical City today to elevate your toolbox and get exclusive deals.
            </p>
